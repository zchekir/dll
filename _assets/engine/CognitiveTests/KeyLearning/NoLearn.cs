...
namespace engine.CognitiveTests.KeyLearning
{
    ...
    public class NoLearn
    {
        ...
        /// <summary>
        /// This will pick up from the No Learn Instructions screen
        /// and continue to press the "d" key untill the test ends
        /// </summary>
        [UserCodeMethod]
        public static void RunNoLearn(String DOM)
        {
			...
			//start timer, no learn task will end after 10 seconds
			sw.Start();
