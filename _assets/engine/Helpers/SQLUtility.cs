...
//				"FROM [Reports].[vwExtractStandardAssessmentDetail] WHERE TestIdentifier = '" + WebService.TestIdentifier + "' ORDER BY TestId, Round ASC";
	...
	GROUP BY Assessment.Assessment.Id, 
        ...
        /// <summary>
        /// This will query the database and store the results of the completed assessment into a datatable. This requires passing in a specific
        /// test identifier
        /// </summary>
        /// <param name="testIdentifier">The Test ID you want to find in the database</param>
        /// <param name="dbserver">The server you want to connect to</param>
        /// <param name="database">The database name to query</param>
        /// <param name="username">Username credential for the server</param>
        /// <param name="password">Password credential for the server</param>
        /// <param name="authentication">The authenticaiton method for connecting to the database. This is only needed for connecting using domain username and password</param>
        [UserCodeMethod]
        public static void GetAssessmentOutcomes(string testIdentifier, string dbserver, string database, string username, string password, string authentication)
        {
        	dt.Clear();
