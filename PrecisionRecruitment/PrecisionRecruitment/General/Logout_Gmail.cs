...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            repo.GmailInbox.AccountButton.Click();
            ...
            repo.GmailInbox.SignOutButton.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'GmailInbox'.", repo.GmailInbox.SelfInfo, new RecordItemIndex(2));
            Host.Current.CloseApplication(repo.GmailInbox.Self, new Duration(0));
            Delay.Milliseconds(0);
