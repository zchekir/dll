...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '3 Tier' with focus on 'CogstateSolutionPlatform.AddWorkflowPage.WorkflowTemplateDropdown'.", repo.CogstateSolutionPlatform.AddWorkflowPage.WorkflowTemplateDropdownInfo, new RecordItemIndex(1));
            repo.CogstateSolutionPlatform.AddWorkflowPage.WorkflowTemplateDropdown.PressKeys("3 Tier");
