...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence 'Pre' with focus on 'CogstateSolutionPlatform.AddWorkflowPage.WorkflowTypeDropdown'.", repo.CogstateSolutionPlatform.AddWorkflowPage.WorkflowTypeDropdownInfo, new RecordItemIndex(1));
            repo.CogstateSolutionPlatform.AddWorkflowPage.WorkflowTypeDropdown.PressKeys("Pre");
