...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            repo.CogstateSolutionPlatform.AddBatteryPage.BatteryNameField.Click();
            ...
            repo.CogstateSolutionPlatform.AddBatteryPage.BatteryNameField.PressKeys("{End}{LShiftKey down}{Home}{LShiftKey up}{Delete}", 100);
            Delay.Milliseconds(0);
