...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'CogstateSolutionPlatform.AddBatteryPage.BatteryPopulationDropdown' at 137;16.", repo.CogstateSolutionPlatform.AddBatteryPage.BatteryPopulationDropdownInfo, new RecordItemIndex(0));
            repo.CogstateSolutionPlatform.AddBatteryPage.BatteryPopulationDropdown.Click("137;16");
            Delay.Milliseconds(200);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'CogstateSolutionPlatform.Expanded.BatteryHealthyPopulation' at 51;5.", repo.CogstateSolutionPlatform.Expanded.BatteryHealthyPopulationInfo, new RecordItemIndex(1));
            repo.CogstateSolutionPlatform.Expanded.BatteryHealthyPopulation.Click("51;5");
            Delay.Milliseconds(200);
