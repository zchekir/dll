...
namespace CPA.APIV2Modules
{
    ...
    public partial class Get_AssessmentAttemptOutcomes
    {
        /// <summary>
        ...
        public void AssessmentAttemptOutcomes(string DOM, string TestIdentifier, string AuthToken, string StudyProtocolName)
        {
           //Setup API call
