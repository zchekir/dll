...
{
	public class AssessmentAttemptJSONRequestS3
	{
		/// <summary>---------------------------------------------------------
		...
		public AssessmentAttemptJSONRequestS3(string externalId, string dob, string genderCode, string localityCode,
	...
	/// </summary>
	public class AssessmentAttemptJSONResponseS3
	{
		...
		public AssessmentAttemptJSONResponseS3()
		{
    ...
    public partial class S3WorkFlow
    {
        /// <summary>
        ...
        private void Init()
        {
            // Your recording specific initialization code goes here.  S33333 
        }

        public void GenerateWF(string AuthToken, string studyProtocolName, string DOM, string dob, string genderCode, string localityCode, string redirectError, string redirect, string mode)
        {
           //variable
			...
			AssessmentAttemptJSONRequestS3 assessmentObject = new AssessmentAttemptJSONRequestS3(externalId, dob, genderCode, localityCode, redirectError, redirect, visitSessionCode, supervisorId,mode);
			...
			AssessmentAttemptJSONResponseS3 responseObject = new AssessmentAttemptJSONResponseS3();
			
			using (StreamReader sr = new StreamReader(httpResponse.GetResponseStream()))
			{
				string response = sr.ReadToEnd();
				responseObject = new JavaScriptSerializer().Deserialize<AssessmentAttemptJSONResponseS3>(response);
