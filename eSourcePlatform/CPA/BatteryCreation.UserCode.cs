...
namespace CPA
{
    ...
    public partial class BatteryCreation
    {
        ...
        public void battery_Creation(string Token, string Studyid, string JsonData, string CPADOM, string Batteryversion)
        {
        	
        
        	
			//variable
		    string url = "https://" + CPADOM + "/api/studies/" + Studyid + "/batteries";
			//Setup API call
