...
public class BatteryWorkflowJSONRequest
	...
	public partial class SetBatteryWorkflow
    {
        ...
        public void SetBatteryWorkf(string StudyID, string Token, string WorkflowID, string BatteryID, string CPADOM, string battryworkflowData, string WorkflowBlockID)
        {
