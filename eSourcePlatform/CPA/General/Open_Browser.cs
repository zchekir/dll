...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Website", "Opening web site URL in variable $CPAURL with browser specified by variable $Browser in maximized mode.", new RecordItemIndex(0));
            Host.Current.OpenBrowser(CPAURL, Browser, "", false, true, false, false, false, true);
