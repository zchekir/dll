...
namespace CPA
{
   public class visitJSONRequest
	...
	public partial class CreateVisitschedule
    {
        ...
        public void Visitschedulecreation(string Token, string Studyid, string VisitCode, string CPADOM, string VisitSceduleData, string workflowID)
        {
        	
        	try{
           
        	 //variable
		    string url = "https://" + CPADOM + "/api/studies/" + Studyid + "/visitSchedules";
			//Setup API call
