...
namespace CPA
{
    ...
    public partial class GetNextStateWoklowID
    {
        ...
        public void NextStateWorkflowID(string Token, string StudyID, string WorkflowID, string BatteryID, string JSONDATA, string CPADOM)
        {
            
        	
        	
        	 //variable
		    string url = "https://" + CPADOM + "/api/workflows/"+WorkflowID;
			//Setup API call
