...
namespace CPA.LoginPage
{
    public partial class Enter_Email
    {
        ...
        public void Try_Enter_Email(RepoItemInfo EmailField)
        {
        	...
        	{
        		while (EmailField.FindAdapter<InputTag>().Value != CPAUsername)
        		{
