...
namespace CPA.LoginPage
{
	public partial class Enter_Password
	{
		...
		public void Try_Enter_Password(RepoItemInfo PasswordField)
		{
			...
			{
				while (PasswordField.FindAdapter<InputTag>().Value != CPAPassword)
				{
