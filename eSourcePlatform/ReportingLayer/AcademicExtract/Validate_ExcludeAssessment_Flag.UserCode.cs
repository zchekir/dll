...
{
    public partial class Validate_ExcludeAssessment_Flag
    {
        ...
        public void ReportFlag()
        {
        	...
        	//Check first row in the Academic Extract. If true ('1') is returned, this indicated the assesment has been excluded
        	if ((bool)dt.Rows[0]["ExcludeAssessment"])
        		Report.Success("Assessment has been marked as excluded in the Academic Extract View");
        	else
            	Report.Failure("Assessment has not been marked as excluded in the Academic Extract View");
