...
{
    public partial class Validate_AssessmentTestOutcomeSAT_Entry
    {
		...
		/// </summary>         
        public void GetAssessmentTestOutcomesSAT(string database, string dbserver, string username, string password, string authentication)
        {
            dt.Reset();
        	
        	//Setup SQL Query
        	string query = @"SELECT * FROM Assessment.AssessmentTestOutcomeSAT
        ...
        public void ReportRecords()
        {
        	...
        	string[] expectedOutcomes = new string[] {"ProtocolName", "IQNumber", "TestId", "AssessmentTestId", "TestCompletion", "TestPerformance", "ReactionTime", "RawReactionTime",
        		...
        		"TotalPost", "TotalMaxout", "SATScore", "TotalCorrectExclPant", "TestDuration", "PrimaryOutcome"};
        	...
        	{
        		Report.Success("AssessmentTestOutcomeSAT Table contains all expected outcomes");
        		...
        		foreach (DataRow row in dt.Rows)
        		{
        			...
        			{
        				Report.Success("AssessmentTestOutcomeSAT results have been added to the Reporting Database successfully");        				
        			}
        			else
        			{
        				Report.Failure("AssessmentTestOutcomeSAT have not been added/does not appear in the Reporting Database");        				
        			}
        		}
        	}
        	else
