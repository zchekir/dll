...
{
    public partial class Validate_AssessmentTestOutcomeMaze_Entry
    {
		...
		/// </summary>  
        public void GetAssessmentTestOutcomeMaze(string database, string dbserver, string username, string password, string authentication)
        {
            dt.Reset();
        	
        	//Setup SQL Query
        	string query = @"SELECT * FROM Assessment.AssessmentTestOutcomeMaze
        ...
        public void ReportRecords()
        {
        	...
        	string[] expectedOutcomes = new string[] {"ProtocolName", "IQNumber", "TestId", "AssessmentTestId", "TestCompletion", "TestPerformance", "TotalCorrect", "TotalErrors",
            	"LegalErrors", "RuleBreakErrors", "PerseverativeErrors", "ReturnToHead", "MovesPerSecond", "StandardScoreZ", "StandardScoreT", 
            	"ChangeScore", "GMLTIndex", "TestDuration", "PrimaryOutcome"};
        	...
        	{
        		Report.Success("AssessmentTestOutcomeMaze Table contains all expected outcomes");
        		...
        		foreach (DataRow row in dt.Rows)
        		{
        			...
        			{
        				Report.Success("AssessmentTestOutcomeMaze results have been added to the Reporting Database successfully");        				
        			}
        			else
        			{
        				Report.Failure("AssessmentTestOutcomeMaze have not been added/does not appear in the Reporting Database");        				
        			}
        		}
        	}
        	else
