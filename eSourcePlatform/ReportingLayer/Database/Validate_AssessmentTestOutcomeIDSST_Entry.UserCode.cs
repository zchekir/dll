...
{
    public partial class Validate_AssessmentTestOutcomeIDSST_Entry
    {
		...
		/// </summary>            
        public void GetAssessmentTestOutcomeIDSST(string database, string dbserver, string username, string password, string authentication)
        {
        	dt.Reset();
        	
        	//Setup SQL Query
        	string query = @"SELECT * FROM Assessment.AssessmentTestOutcomeIDSST
        ...
        public void ReportRecords()
        {
        	...
        	{
        		Report.Success("AssessmentTestOutcomeIDSST Table contains all expected outcomes");
        		...
        		foreach (DataRow row in dt.Rows)
        		{
        			...
        			{
        				Report.Success("AssessmentTestOutcomeIDSST results have been added to the Reporting Database successfully");        				
        			}
        			else
        			{
        				Report.Failure("AssessmentTestOutcomeIDSST have not been added/does not appear in the Reporting Database");        				
        			}
        		}
        	}
        	else
