...
{
    public partial class Validate_AcademicExtract_View
    {
        ...
        /// <summary>
        /// Queries the Academic Extract view for records and stores in the DataTable
        /// </summary>
        public void GetAcademicExtract(string database, string dbserver, string username, string password, string authentication)
        {
            dt.Reset();
        	
        	//Setup SQL Query
        	string query = @"SELECT * FROM extracts.vwAcademicExtract
        ...
        /// <summary>
        /// Prints the contents of the DataTable to the Report and confirms the Academic Extract view contains the completed assessment
        ...
        public void ReportRecords()
        {
        	...
        	{
        		Report.Success("AcademicExtract View contains all expected outcomes");
        		...
        		foreach (DataRow row in dt.Rows)
        		{
        			...
        			{
        				Report.Failure("AcademicExtract view results have not been added/does not appear in the Reporting Database correctly");
        				resultsFlag = false;
        				break;
        			}
        		}
        		...
        		if (resultsFlag) 
        		{
        			Report.Success("AcademicExtract view results have been added to the Reporting Database Successfully");
        		}
        	}
        	else
        	{
