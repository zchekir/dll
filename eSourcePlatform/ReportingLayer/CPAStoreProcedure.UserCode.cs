...
{
    public partial class CPAStoreProcedure
    {
        ...
        public void ExecuteCPAStoreProcedure(string DBServer, string Database, string dbUsername, string dbPassword, string Authentication, string studID)
        {
        	...
        	dt.Reset();
             ...
             // Executing the store procedure in order to update [Reports].[uspUpdateExtractStandardAssessmentDetail] table
                 ...
                 string query = @"EXECUTE [Reports].[uspUpdateExtractStandardAssessmentDetail] ";
