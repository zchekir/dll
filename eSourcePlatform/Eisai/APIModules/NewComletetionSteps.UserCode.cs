...
namespace Eisai.APIModules
{
    ...
    public partial class NewComletetionSteps
    {
        ...
        public void Stepcompletation(string Token, string BlockID, string WorkflowID, string JSONData, string studid, string NextBlockid, string batteryID, string DeskTopID)
        {
