...
{
	public partial class Reporting_DBVersion
	{
		//variables:
		...
		public void Check_Version(string dbserver, string database, string password, string username, string authentication, string migrationid)
		{
