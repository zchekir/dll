...
namespace EisiaProject
{
    public partial class internalUserCreation
    {
        ...
        public void internalUser(string DBServer, string Database, string dbUsername, string dbPassword, string Authentication, string InternalPassword, string InternalUserName)
        {
