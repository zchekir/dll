...
namespace Cognigram_
{
    ...
    public partial class debugHTML
    {
        string response;
        ...
        public void CognigramDebug(string DOM)
        {
        	try{
            string url = "https://" + DOM +"/workflowinstance_debug.html";
			...
			debugStatus responseObject = new  debugStatus();
			using (StreamReader sr = new StreamReader(httpResponse.GetResponseStream()))
			{
			    response= sr.ReadToEnd();
				responseObject = new JavaScriptSerializer().Deserialize<debugStatus>(response);
