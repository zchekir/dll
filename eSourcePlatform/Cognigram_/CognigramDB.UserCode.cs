...
{
    public partial class CognigramDB
    {
    	//variables:
        ...
        public void CognigramdataBases(string DBServer, string Database, string dbUsername, string dbPassword, string Authentication, string MigrationId)
        {
            //Validating the CPA DB Version
			...
			dt.Reset();
				...
				try{
			     ...
			     //Pringting the Current CPA DB version:
			     Report.Log(ReportLevel.Info,  "CPA DB version: " + "  " + dbvID[0]  );
