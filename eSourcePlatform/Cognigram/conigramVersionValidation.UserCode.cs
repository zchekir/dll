...
namespace Cognigram
{
    ...
    public partial class conigramVersionValidation
    {
        ...
        public void ConigramVersion(string DOM, string ConigramExpectedVersion, string conigramSversion)
        {
			...
			string currentconigramPlatformversion = conigramSversion.Split('.')[0];
			//Sversion = splitVersion[0] + "." + splitVersion[1] + "." + splitVersion[2];
			Report.Log(ReportLevel.Info, "currentconigramPlatformversion"+ currentconigramPlatformversion );
