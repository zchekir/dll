...
{
    /// <summary>
    /// Description of Validate_Sponsor_Descending.
    /// </summary>
    [TestModule("D95D1E04-A7BD-4B07-A13C-7EB9E4576A4A", ModuleType.UserCode, 1)]
    public class Validate_Sponsor_Descending : ITestModule
    {
        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Validate_Sponsor_Descending()
        {
            // Do not delete - a parameterless constructor is required!
        }
        
        public static CSP.CSPRepository repo = CSP.CSPRepository.Instance;
        ...
        void ITestModule.Run()
        {
            ...
            //Find the second /td/a cell in each table row. This is the Sponsor Name. Store them in two lists
            foreach (TrTag row in repo.CogstateSolutionPlatform.StudyTableHeaders.TableBody.Find("./tr"))
            {
            	...
            	originalList.Add(cells[1].InnerText);
            	sortedList.Add(cells[1].InnerText);
