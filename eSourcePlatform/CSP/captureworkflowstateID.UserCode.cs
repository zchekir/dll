...
namespace CSP
{
    public partial class captureworkflowstateID
    {
        ...
        public void workflowstateID(string DBServer, string Database, string dbUsername, string dbPassword, string Authentication, string stateid, string stuid)
        {
			...
			string query = @"SELECT 
                           id
                           FROM [Study].[StudRol]
                           where [Name]='External Service' and (studid=@stuid or id=39)";
