...
namespace CSP
{
    ...
    public partial class Assessment_AttemptStatus
    {
        /// <summary>
        ...
        public void Assessment_Attempt_Status(string studyProtocolName, string DOM, string TestIdentifier, string authoToken)
        {
