...
{
	public class dataJSONResponse6
	{
    ...
    public partial class UB06
    {
        ...
        public void UpdateBatterySix(string workflowID, string DOM, string workflowToken, string Batteryid, string rawdata)
        {
           //Setup API call
		 ...
		 using (StreamWriter sw = new StreamWriter(httpRequest.GetRequestStream()))
			...
			dataJSONResponse6 responseObject = new dataJSONResponse6();
			
			using (StreamReader sr = new StreamReader(httpResponse.GetResponseStream()))
			{
				string response = sr.ReadToEnd();
				responseObject = new JavaScriptSerializer().Deserialize<dataJSONResponse6>(response);
