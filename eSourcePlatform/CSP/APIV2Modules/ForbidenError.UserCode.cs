...
namespace CSP.APIV2Modules
{
	public class AssessmentAttemptJSONRequest3
	{
		...
		public AssessmentAttemptJSONRequest3(string externalId, string InvalidDOB, string genderCode, string localityCode,
    ...
    public partial class ForbidenError
    {
        ...
        public void WorkflowInstance2(string AuthToken, string studyProtocolName, string DOM, string InvalidDOB, string genderCode, string localityCode, string postError, string mode, string post)
        {
			...
			AssessmentAttemptJSONRequest3 assessmentObject = new AssessmentAttemptJSONRequest3(externalId, InvalidDOB, genderCode, localityCode, postError, post, visitSessionCode, supervisorId,mode);
