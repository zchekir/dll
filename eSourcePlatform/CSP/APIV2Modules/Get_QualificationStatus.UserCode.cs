...
namespace CSP.APIV2Modules
{
	...
	public partial class Get_QualificationStatus
	{
		/// <summary>
		...
		public void GetQualificationStatus(string TestIdentifier, string studyProtocolName, string DOM, string AuthToken)
		{
			//Setup API call
