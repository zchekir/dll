...
namespace CSP
{
    public partial class RrunWorkflow
    {
        ...
        public void R_runworkflow(string authoToken, string studyProtocolName, string DOM, string genderCode, string localityCode, string postError, string post, string visitSessionCode, string supervisorid, string TestIdentifier, string externalid)
        {
            //variable
