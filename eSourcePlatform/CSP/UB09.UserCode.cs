...
namespace CSP
{
	...
	public class dataJSONResponse9
	{
    ...
    public partial class UB09
    {
        ...
        public void UpdateBatteryNine(string workflowID, string DOM, string workflowToken, string Batteryid, string rawdata)
        {
           //Setup API call
		 ...
		 using (StreamWriter sw = new StreamWriter(httpRequest.GetRequestStream()))
			...
			dataJSONResponse9 responseObject = new dataJSONResponse9();
			
			using (StreamReader sr = new StreamReader(httpResponse.GetResponseStream()))
			{
				string response = sr.ReadToEnd();
				responseObject = new JavaScriptSerializer().Deserialize<dataJSONResponse9>(response);
