...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'S3ManagementConsole.OpenExportFolder' at Center.", repo.S3ManagementConsole.OpenExportFolderInfo, new RecordItemIndex(2));
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'S3ManagementConsole.ClickDownload' at Center.", repo.S3ManagementConsole.ClickDownloadInfo, new RecordItemIndex(4));
            repo.S3ManagementConsole.ClickDownload.Click();
            Delay.Milliseconds(200);
            
            Report.Log(ReportLevel.Info, "Delay", "Waiting for 6s.", new RecordItemIndex(5));
