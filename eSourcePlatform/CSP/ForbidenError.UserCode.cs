...
namespace CSP
{
	public class AssessmentAttemptJSONRequest3
	{
		/// <summary>---------------------------------------------------------
		...
		public AssessmentAttemptJSONRequest3(string externalId, string dob, string genderCode, string localityCode,
	...
	/// </summary>
	public class AssessmentAttemptJSONResponse3
	{
		...
		public AssessmentAttemptJSONResponse3()
		{
			
		}
	}
	public partial class WorkflowInstance2
	{
    ...
    public partial class ForbidenError
    {
        /// <summary>
        ...
        public void WorkflowInstance2(string AuthToken, string studyProtocolName, string DOM, string dob, string genderCode, string localityCode, string postError, string mode, string post)
        {
        	try{
			//variable
			...
			AssessmentAttemptJSONRequest3 assessmentObject = new AssessmentAttemptJSONRequest3(externalId, dob, genderCode, localityCode, postError, post, visitSessionCode, supervisorId,mode);
			...
			AssessmentAttemptJSONResponse3 responseObject = new AssessmentAttemptJSONResponse3();
			
			using (StreamReader sr = new StreamReader(httpResponse.GetResponseStream()))
			{
				string response = sr.ReadToEnd();
				responseObject = new JavaScriptSerializer().Deserialize<AssessmentAttemptJSONResponse3>(response);
